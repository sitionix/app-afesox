...
4. Use the dependency snippet from the success comment to consume the unstable JAR. If the build fails, review the failure comment linked to the workflow logs.
